  ...
  return (
    <div className="flex-1 bg-background text-foreground py-12 px-6 md:px-12 relative flex flex-col items-center font-sans">
      ...
      <div className="text-center max-w-xl mt-8 mb-16">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pop-yellow text-slate-900 border-2 border-border text-[9px] font-game font-extrabold uppercase mb-4 tracking-wider shadow-[2px_2px_0px_var(--shadow-color)]">
